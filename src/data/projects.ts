...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: {
      fr: "Modernisation réseau sans fil et vidéosurveillance pour l'entrepôt de Lyon.",
      en: "Wireless network and CCTV upgrade for the Lyon warehouse.",
      zh: "里昂老仓Wi-Fi 6及监控系统升级。",
    },
    highlights: [
